from crawler.updater.service import (
    image_update_service, image_crawl_back_service
)
from loguru import logger
from sqlite3 import Connection


def crawl_back_image_sources(
    image_source_catalog: dict,
    database: Connection
) -> dict:
    updated_sources = {}
